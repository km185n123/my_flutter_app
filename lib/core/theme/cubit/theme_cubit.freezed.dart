...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AppThemeMode themeMode, bool isDarkMode});
}
...
class _$ThemeStateImpl implements _ThemeState {
  const _$ThemeStateImpl(
      {this.themeMode = AppThemeMode.system, this.isDarkMode = false});
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeMode, isDarkMode);
...
abstract class _ThemeState implements ThemeState {
  const factory _ThemeState(
      {final AppThemeMode themeMode, final bool isDarkMode}) = _$ThemeStateImpl;
